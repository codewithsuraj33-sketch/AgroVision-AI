...
DISEASE_KNOWLEDGE = {
    ...
    # Healthy classes
    "Pepper__bell___healthy": {"disease": "Healthy", "confidence": None, "cause": "No disease", "symptoms": "Leaf surface looks uniform and healthy.", "recommendation": "Continue monitoring and keep balanced irrigation.", "organic_solution": "Maintain compost, airflow, and preventive scouting.", "solution": "Routine care", "best_product": "N/A", "product_link": ""},
    "Potato___healthy": {"disease": "Healthy", "confidence": None, "cause": "No disease", "symptoms": "Leaf surface looks uniform and healthy.", "recommendation": "Continue monitoring and keep balanced irrigation.", "organic_solution": "Maintain compost, airflow, and preventive scouting.", "solution": "Routine care", "best_product": "N/A", "product_link": ""},
    "Tomato_healthy": {"disease": "Healthy", "confidence": None, "cause": "No disease", "symptoms": "Leaf surface looks uniform and healthy.", "recommendation": "Continue monitoring and keep balanced irrigation.", "organic_solution": "Maintain compost, airflow, and preventive scouting.", "solution": "Routine care", "best_product": "N/A", "product_link": ""},
...
def get_disease_info(model_class_id: str, confidence: float) -> dict:
    ...
    info.setdefault("organic_solution", info.get("recommendation", "Maintain field hygiene and use organic support spray."))
    info["explanation_hinglish"] = f"Aapke photo mein {info['disease']} ({info['confidence']}) ka signal mila. {info['recommendation']}"
    return info
